...
4. Write a Python program to convert a byte string to a list of integers.
...
8. Write a Python program to get the system time.
...
9. Write a Python program to clear the screen or terminal.

10. Write a Python program to get the name of the host on which the routine is running
