...
2. Write a Python program to remove the first item from a specified list.
...
6. Write a Python program to print Unicode characters.

7. Write a Python program to prove that two string variables of same value point same memory location.

8. Write a Python program to create a bytearray from a list.

9. Write a Python program to display a floating number in specified numbers.

10. Write a Python program to format a specified string to limit the number of characters to 6.
